...
// shader src paths
//const char* vertexPath = "Y:/dev/learn_opengl/1.3.shaders_shader_class/shaders/vertex_shader.vert";
//const char* fragmentPath = "Y:/dev/learn_opengl/1.3.shaders_shader_class/shaders/fragment_shader.frag";
